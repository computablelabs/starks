...
setup(
    ...
    entry_points={
        'console_scripts': [
            "starks=starks.cli.starks_compile:_parse_cli_args",
            "starks-serve=starks.cli.starks_serve:_parse_cli_args",
            "starks-lll=starks.cli.starks_lll:_parse_cli_args",
            "starks-json=starks.cli.starks_json:_parse_cli_args",
        ]
    },
    classifiers=[
