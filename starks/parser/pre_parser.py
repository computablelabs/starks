...
def pre_parse(code: str) -> Tuple[ClassTypes, str]:
    """
    Re-formats a starks source string into a python source string and performs
    ...
    * Prevents use of python semi-colon statement separator
    ...
    respective starks class types ("contract" or "struct").

    :param code: The starks source code to be re-formatted.
