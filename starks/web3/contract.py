...
from starks.web3._utils.abi import (
    abi_to_signature,
...
from starks.web3._utils.blocks import (
    is_hex_encoded_block_hash,
)
from starks.web3._utils.contracts import (
    encode_abi,
...
from starks.web3._utils.datatypes import (
    PropertyCheckingFactory,
)
from starks.web3._utils.decorators import (
    combomethod,
    deprecated_for,
)
from starks.web3._utils.empty import (
    empty,
)
from starks.web3._utils.encoding import (
    to_4byte_hex,
    to_hex,
)
from starks.web3._utils.events import (
    EventFilterBuilder,
    get_event_data,
    is_dynamic_sized_type,
)
from starks.web3._utils.filters import (
    construct_event_filter_params,
)
from starks.web3._utils.function_identifiers import (
    FallbackFn,
)
from starks.web3._utils.normalizers import (
    BASE_RETURN_NORMALIZERS,
    normalize_abi,
    normalize_address,
    normalize_bytecode,
)
from starks.web3._utils.transactions import (
    fill_transaction_defaults,
)
from starks.web3.datastructures import (
    AttributeDict,
    MutableAttributeDict,
)
from starks.web3.exceptions import (
...
class ContractEvents:
    ...
    .. code-block:: python
        ...
        >>> mycontract.events
        <starks.web3.contract.ContractEvents object at 0x108afde10>
    ...
    .. code-block:: python
        ...
        <class 'starks.web3._utils.datatypes.LogAnonymous'>
        ...
