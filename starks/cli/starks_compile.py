...
from starks.settings import (
    STARKS_TRACEBACK_LIMIT,
)
from starks.signatures.interface import (
...
interface          - Print Starks interface of a contract
...
def _parse_args(argv):
    ...
    parser = argparse.ArgumentParser(
        description='Starks programming language for Computable',
    ...
    if args.traceback_limit is not None:
    ...
    elif STARKS_TRACEBACK_LIMIT is not None:
        sys.tracebacklimit = STARKS_TRACEBACK_LIMIT
    else:
        ...
        # an error occurred in a Starks source file.
