...
from starks.functions.signatures import (
    signature,
)
...
def convert(expr, context):
    ...
    if isinstance(expr.args[1], ast.Str):
        warnings.warn(
            "String parameter has been removed. "
            "Use a starks type instead.",
            DeprecationWarning
        )
    ...
    if isinstance(expr.args[1], ast.Name):
        ...
        raise ParserException("Invalid conversion type, use valid Starks type.", expr)
