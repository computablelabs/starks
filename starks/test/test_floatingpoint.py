...
class TestFloatingPoint(unittest.TestCase):
  ...
  def test_addition(self):
    ...
    assert floating_point(field(polysOver([0,1])), field(polysOver([1,1])), 0, 0) == floating_point(field(polysOver([1,0,1])), field(polysOver([1,1])), 0, 1) + floating_point(field(polysOver([1,1,1])), field(polysOver([1,1])), 0, 0)
  ...
  def test_subtraction(self):
    ...
    assert floating_point(field(polysOver([0])), field(polysOver([1])), 1, 1) == floating_point(field(polysOver([1,1,1])), field(polysOver([1])), 0, 0) - floating_point(field(polysOver([1,1,1])), field(polysOver([1])), 0, 0)
    assert floating_point(field(polysOver([1,1])), field(polysOver([1,1,1])), 0, 0) == floating_point(field(polysOver([1,1])), field(polysOver([1,1,1])), 0, 0) - floating_point(field(polysOver([1])), field(polysOver([0])), 0, 0)
