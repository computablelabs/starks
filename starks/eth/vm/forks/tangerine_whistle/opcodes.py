...
from starks.eth.vm.forks.tangerine_whistle import constants
from starks.eth.constants import GAS_CREATE
from starks.eth.vm import opcode_values
from starks.eth.vm import mnemonics
from starks.eth.vm.forks.homestead.opcodes import HOMESTEAD_OPCODES
