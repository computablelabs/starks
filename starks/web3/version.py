from starks.web3.method import (
    Method,
)
...
class Version(Module):
    ...
    def api(self):
        raise DeprecationWarning(
            "This method has been deprecated ... Please use starks.web3.api instead."
        )

    @property
    def node(self):
        raise DeprecationWarning(
            "This method has been deprecated ... Please use starks.web3.clientVersion instead."
        )

    @property
    def ethereum(self):
        raise DeprecationWarning(
            "This method has been deprecated ... Please use starks.web3.eth.protocolVersion instead."
        )
