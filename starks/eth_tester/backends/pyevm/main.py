...
from starks.eth_tester.backends.common import merge_genesis_overrides
...
if is_pyevm_available():
    ...
    from starks.eth.vm.spoof import (
...
def setup_tester_chain(genesis_params=None, genesis_state=None, num_accounts=None):
    from starks.eth.chains.base import MiningChain
    from starks.eth.db import get_db_backend
    from starks.eth.vm.forks.istanbul import IstanbulVM
