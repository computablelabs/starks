...
from starks.eth.db.backends.base import BaseDB, BaseAtomicDB
from starks.eth.db.backends.memory import MemoryDB
...
class AtomicDB(BaseAtomicDB):
    ...
    """
    logger = logging.getLogger("starks.eth.db.AtomicDB")
