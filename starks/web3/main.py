...
from starks.web3._utils.module import (
    attach_modules,
)
from starks.web3._utils.normalizers import (
    abi_ens_resolver,
)
from starks.web3.eth import (
    Eth,
)
from starks.web3.geth import (
    Geth,
    GethAdmin,
    GethMiner,
    GethPersonal,
...
from starks.web3.iban import (
    Iban,
)
from starks.web3.manager import (
    RequestManager as DefaultRequestManager,
)
from starks.web3.net import (
    Net,
)
from starks.web3.parity import (
    Parity,
    ParityPersonal,
    ParityShh,
)
...
from starks.web3.providers.ipc import (
    IPCProvider,
)
from starks.web3.providers.rpc import (
    HTTPProvider,
)
from starks.web3.providers.websocket import (
    WebsocketProvider,
)
from starks.web3.testing import (
    Testing,
)
from starks.web3.version import (
    Version,
)
...
class Web3:
    ...
    @property
    def api(self):
        from starks.web3 import __version__
        return __version__
