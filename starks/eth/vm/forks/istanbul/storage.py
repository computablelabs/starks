from starks.eth.exceptions import OutOfGas
from starks.eth.vm.computation import BaseComputation
from starks.eth.vm.forks.constantinople.storage import (
    GAS_SCHEDULE_EIP1283,
)
from starks.eth.vm.forks.istanbul import (
    constants
)
from starks.eth.vm.logic.storage import (
    net_sstore,
)
